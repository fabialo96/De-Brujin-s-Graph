...
public class Flatmap implements PairFlatMapFunction <Tuple2<String, Iterable<Tuple3<String, Integer, Integer>>>,
String, Tuple3<String,Integer,Integer>> {
	...
	@Override
	public Iterator<Tuple2<String, Tuple3<String, Integer, Integer>>> call(
			Tuple2<String, Tuple3<String, Integer, Integer>> t) throws Exception {
		
		List<Tuple2<String, Tuple3<String, Integer, Integer>>> output = new ArrayList<Tuple2<String, Tuple3<String, Integer, Integer>>>();
		
		output.add(new Tuple2<>(t._2._1(), new Tuple3<>( t._1,t._2._2(),t._2._3())));
